...
echo '<script>alert("Votre profil est mis à jour")</script>';
}
...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Système de gestion de librairie en ligne | Profil Utilisateur</title>
...
<div class="form-group">
<label>Date de la dernnnière mise à jour : </label>
