...
<head>
    ...
    <title>Système de gestion de librairie en ligne | Mot de passe perdu </title>
...
<div class="col-md-12">
<h4 class="header-line">Utilisateur pour le mot de passe</h4>
</div>
</div>
...
<input type="text" class="form-control1"  name="vercode" maxlength="5" autocomplete="off" required  style="height:25px;" />&nbsp;<img src="captcha.php">
 ...
 <button type="submit" name="change" class="btn btn-info">Changer le mot de passe</button> | <a href="index.php">Login</a>
</form>
 </div>
</div>
</div>
