...
$query->execute();
$_SESSION['msg']="Mise à jour du livre avec succès";
...
<head>
    ...
    <title>Système de gestion de librairie en ligne | Editer un livre</title>
...
<p class="help-block">L'ISBN est  "International Standard Book Number".L'ISBN est unique</p>
</div>
