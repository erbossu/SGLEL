<div class="navbar navbar-inverse set-radius-zero" >
        <div class="container">
            ...
            <div class="right-div">
                <a href="logout.php" class="btn btn-danger pull-right">Déconnecter</a>
            </div>
        </div>
    </div>
    <!-- LOGO HEADER END-->
 ...
 <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Livre <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                           ...
                           <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Emprunt d'un livre <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="issue-book.php">Emprunter un livre</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-issued-books.php">Gérer les emprunts de livres</a></li>
                                </ul>
                            </li>
                             <li><a href="reg-students.php">Utilisateurs</a></li>
                    
  <li><a href="change-password.php">Changer de mot de passe</a></li>
                        </ul>
                    </div>
                </div>
