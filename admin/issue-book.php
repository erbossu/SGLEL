...
<head>
    ...
    <title>Système de gestion de librairie en ligne | Emprunt d'un livre</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Emprunter un livre</h4>
...
<label>Utilisateur id<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Chercher </button>
