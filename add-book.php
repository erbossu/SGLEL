...
if($lastInsertId)
{
$_SESSION['msg']="Catalogue de livres réussi";
...
<head>
    ...
    <title>Système de gestion de librairie en ligne | Alouter un livre</title>
...
<p class="help-block">le numéro ISBN est "International Standard Book Number".ISBN est unique</p>
</div>
